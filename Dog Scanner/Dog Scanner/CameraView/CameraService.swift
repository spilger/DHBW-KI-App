    ...
    public func checkForPermissions() {
        ...
        default:
            ...
            DispatchQueue.main.async {
                self.alertError = AlertError(title: "Camera Access", message: "Animated Sticker Maker doesn't have access to use your camera, please update your privacy settings.", primaryButtonTitle: "Settings", secondaryButtonTitle: nil, primaryAction: {
...
//        We use our capture session queue to ensure our UI runs smoothly on the main thread.
    ...
    /// - Tag: CapturePhoto
    public func capturePhoto(queue: DispatchGroup) {
