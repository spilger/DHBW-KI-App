...
final class CameraModel: ObservableObject {
    ...
    // MARK: - Capture Photo
    func capturePhoto(group: DispatchGroup) {
        service.capturePhoto(queue: group)
    }
    // MARK: - Capture Video
    func captureVideo(capturing: State<Bool>) {
...
struct CameraView: View {
    ...
    @State public var captureMode = 0
    
    @State public var capturing = false
    
    @State public var sheetShowhn = false
    
    var captureButton: some View {
        Button(action: {
            if captureMode == 0 {
                let group = DispatchGroup() // initialize
                model.capturePhoto(group: group)
                group.enter()
        ...
        GeometryReader { reader in
            ZStack {
                ...
                VStack {
                    ...
                    HStack {
                        capturedPhotoThumbnail.padding()
